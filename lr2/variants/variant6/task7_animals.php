...
$syllablesInput = $_POST['syllables'] ?? 'ча ке ло ну ро ди фа ти пу ма';
...
<div class="demo-card">
    ...
    <form method="post" class="demo-form">
        <div>
            ...
            <input type="text" id="syllables" name="syllables" value="<?= htmlspecialchars($syllablesInput) ?>" placeholder="ча ке ло ну ро">
        </div>
        <div class="form-row">
            <div>
    ...
    <div>
        <h3 class="demo-section-title-success">Згенеровані імена (4 шт.)</h3>
        <div class="array-display">
    ...
    <div class="demo-code">$syllables = ["ча", "ке", "ло", "ну", "ро", "ди", "фа", "ти", "пу", "ма"];
// Результат генерації по <?= $syllablesPerName ?> склади:
